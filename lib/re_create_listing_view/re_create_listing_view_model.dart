...
import 're_create_listing_view_widget.dart' show ReCreateListingViewWidget;
import 'package:flutter/material.dart';

class ReCreateListingViewModel
    extends FlutterFlowModel<ReCreateListingViewWidget> {
  ...
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  ListingsRecord? listingReferenceRecreation;
