...
class AuthenticationViewWidget extends StatefulWidget {
  const AuthenticationViewWidget({super.key});

  @override
  _AuthenticationViewWidgetState createState() =>
      _AuthenticationViewWidgetState();
}

class _AuthenticationViewWidgetState extends State<AuthenticationViewWidget>
    with TickerProviderStateMixin {
  late AuthenticationViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthenticationViewModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AuthenticationView'});
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'AUTHENTICATION_VIEW_Button-Login_ON_TAP');
                                            ...
                                            FFAppState().update(() {
                                              FFAppState().activePage =
                                                  'ListView';
                                              FFAppState().ShowBusinessColumn = loggedIn
                                                  ? ((valueOrDefault(
                                                              currentUserDocument
                                                                  ?.aBNNumber,
                                                              0) !=
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'AUTHENTICATION_VIEW_Container_r3s57hf7_O');
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'AUTHENTICATION_VIEW_Text_jxto05v7_ON_TAP');
                                              FFAppState().update(() {
                                                FFAppState().activePage =
                                                    'ListView';
                                                FFAppState()
                                    ...
                                    children: [
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'h9uiw4mv' /* Enter your first name... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall,
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.phoneNumberCreateFocusNode,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'wxv1iqlg' /* Phone number */,
                                            ),
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall,
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              '1d0zvztp' /* Enter your phone number... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall,
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'AUTHENTICATION_VIEW_Button-CreateUser_ON');
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'AUTHENTICATION_VIEW_Text_248nadnj_ON_TAP');
                                              FFAppState().update(() {
                                                FFAppState().activePage =
                                                    'ListView';
                                                FFAppState()
